...
The following issues are addressed in 17.0.20.10.1:

| Issue Name | Platform | Description | Link |
|------------|----------|-------------|------|
| Import jdk-17.0.20.1+1 | All | Update Corretto baseline to OpenJDK 17.0.20.1+1 | [jdk-17.0.20.1+1](https://github.com/openjdk/jdk17u/releases/tag/17.0.20.1+1) |

The following CVEs are addressed in 17.0.20.10.1:
...
The following issues are addressed in 17.0.19.10.1:

| Issue Name | Platform | Description | Link |
|------------|----------|-------------|------|
| Import jdk-17.0.19+10 | All | Update Corretto baseline to OpenJDK 17.0.19+10 | [jdk-17.0.19+10](https://github.com/openjdk/jdk17u/releases/tag/jdk-17.0.19+10) |
| JDK-8381670 | All | Revert the changes to GZIPInputStream related to InputStream.available() usage | [#268](https://github.com/corretto/corretto-17/pull/268) |

The following CVEs are addressed in 17.0.19.10.1:
...
The following issues are addressed in 17.0.18.9.1:

| Issue Name         | Platform | Description                                                                                     | Link                                                     |
|--------------------|----------|-------------------------------------------------------------------------------------------------|----------------------------------------------------------|
| Revert JDK-8372543 | All      | Revert Shenandoah soft max fix due to incorrect heap usage calculation causing longer GC pauses | [#263](https://github.com/corretto/corretto-17/pull/263) |

## Corretto version: 17.0.18.8.1
...
The following issues are addressed in 17.0.18.8.1:

| Issue Name           | Platform | Description                                                               | Link                                                                          |
|----------------------|----------|---------------------------------------------------------------------------|-------------------------------------------------------------------------------|
| Import jdk-17.0.18+8 | All      | Update Corretto baseline to OpenJDK 17.0.18+8                             | [jdk-17.0.18+8](https://github.com/openjdk/jdk17u/releases/tag/jdk-17.0.18+8) |
| JDK-8372543          | All      | Shenandoah: undercalculated the available size when soft max takes effect | [#256](https://github.com/corretto/corretto-17/pull/256)                      |
| JDK-8365153          | aarch64  | AArch64: Set JVM flags for Neoverse N3 and V3 cores                       | [#255](https://github.com/corretto/corretto-17/pull/255)                      |

The following CVEs are addressed in 17.0.18.8.1:
...
The following issues are addressed in 17.0.13.11.1:

| Issue Name                                 | Platform | Description                                                          | Link                                                                          |
|--------------------------------------------|----------|----------------------------------------------------------------------|-------------------------------------------------------------------------------|
| Import jdk-17.0.13+11                      | All      | Update Corretto baseline to OpenJDK 17.0.13+11                       | [jdk-17.0.13+11](https://github.com/openjdk/jdk17u/releases/tag/jdk-17.0.13+11) |
...
The following CVEs are addressed in 17.0.13.11.1:
