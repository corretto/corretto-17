...
public class TestOnSpinWaitAArch64 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if ("sb".equals(spinWaitInst) && analyzerContains(analyzer, "CPU does not support SB")) {
    ...
    private static boolean analyzerContains(OutputAnalyzer analyzer, String s) {
        return analyzer.getStdout().contains(s) || analyzer.getStderr().contains(s);
    }
